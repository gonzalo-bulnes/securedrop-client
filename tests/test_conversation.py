...
class TestConversationDigest(unittest.TestCase):
    def setUp(self):
        ...
        self._conversation = source.server_collection

    def test_indicates_explicitly_absence_of_messages(self):
        assert conversation.digest([]) == "No messages."

    def test_renders_all_messages(self):
        assert conversation.digest(self._conversation) == dedent(
            """\
            happy-bird wrote:
            Hello! I think this is newsworthy: ...
            ------
