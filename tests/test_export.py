...
from securedrop_client.legacy_export import Export, ExportError
...
def test_run_printer_preflight(mocker):
    ...
    mocker.patch("securedrop_client.legacy_export.TemporaryDirectory", return_value=mock_temp_dir)
    export = Export()
